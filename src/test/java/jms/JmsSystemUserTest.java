...
public class JmsSystemUserTest {
    ...
    public void updateSystemUser() {
        SystemUser systemUser = new SystemUser();
        systemUser.setId("fd8d3e80-7820-4c1d-9fd9-3d80e35489b5");
    ...
    public void deleteSystemUser() {
        ActionResponse delete = os.assets().deleteSystemUser("fd8d3e80-7820-4c1d-9fd9-3d80e35489b5");
        System.out.println(delete);
    }

    @Test
    public void getSystemUser() {
        SystemUser object = os.assets().getSystemUser("fd8d3e80-7820-4c1d-9fd9-3d80e35489b5");
        System.out.println(object.getName());
    }
