...
public class JmsAdminUserTest {
    ...
    public void updateAdminUser() {
        AdminUser object = new AdminUser();
        object.setId("6bd004b1-e77e-4a1b-b323-62b436d64375");
    ...
    public void getAdminUser() {
        AdminUser object = os.assets().getAdminUser("6bd004b1-e77e-4a1b-b323-62b436d64375");
        System.out.println(object.getName());
    }

    @Test
    public void deleteAdminUser() {
        ActionResponse delete = os.assets().deleteAdminUser("6bd004b1-e77e-4a1b-b323-62b436d64375");
